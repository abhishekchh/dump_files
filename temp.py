...
x=os.system('soatestcli -data parasoft_demo -import parasoft_demo')
x=os.system('soatestcli -data parasoft_demo -config "user://Example" -resource Demo/Success.tst -report parasoft_demo\Report\Demo1')
